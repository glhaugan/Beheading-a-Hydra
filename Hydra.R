...
setwd("C:/Users/Haugan-gregory/Desktop/Portfolio/Hydra")
...
map <- map2007 | map2010
leaflet_map <- map@map
saveWidget(leaflet_map, "data/output/MedellinMap.html")
...
ggsave("data/output/plot.png", plot = trendline, width = 12, height = 6, units = "in" , bg = "white")
